...
def is_swap(score0, score1):
    ...
    if ten_0 == unit_1 and ten_1 == unit_0:
        return True
    else:
        return False
    # END Question 4
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score = take_turn(num_rolls, score1, select_dice(score0, score1))
            if score == 0:
                score1 += num_rolls
            else:
                score0 += score
            ...
            score = take_turn(num_rolls, score0, select_dice(score1, score0))
            if score == 0:
                score0 += num_rolls
            else:
                score1 += score
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN Question 10
    # num_rolls = max_scoring_num_rolls(select_dice(score, opponent_score))
    num_rolls = 7
    if swap_strategy(score, opponent_score, num_rolls) == 0:
        return 0
    if bacon_strategy(score, opponent_score, num_rolls = num_rolls) == 0:
        return 0
    return num_rolls  # Replace this statement
    # END Question 10
